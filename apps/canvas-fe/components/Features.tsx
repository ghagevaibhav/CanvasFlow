  ...
  const features = [
    {
      ...
      description:
        "A simple and powerful drawing surface that responds to your every movement.",
    },
    {
      icon: Users,
    ...
    },
    {
      ...
      description:
        "Organize your work with layers to create complex visuals with ease.",
    },
    {
      icon: History,
    ...
    },
    {
      ...
      title: "Easy Sharing",
      description:
        "Share your designs with a simple link or export them in multiple formats.",
    },
    {
      icon: Download,
      title: "Export Options",
      description:
        "Export your artwork in various formats including PNG, SVG, and PDF.",
    },
  ];
      ...
      <div className="container px-4 md:px-6">
        <div className="text-center mb-12">
          ...
          <p className="text-muted-foreground md:text-lg max-w-2xl mx-auto">
            CanvasFlow makes creative collaboration simple with powerful tools
            designed for teams.
          </p>
        </div>
