      ...
      <div className="container px-4 md:px-6">
        <div className="flex flex-col items-center text-center space-y-8 md:space-y-12">
          ...
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold tracking-tighter max-w-2xl animate-slide-down">
            ...
            <span className="bg-gradient-to-r from-primary via-blue-500 to-purple-500 bg-clip-text text-transparent"> Canvas<span className="text-primary">Flow</span></span>
          </h1>
          
          {/* Subheading - Simplified */}
          <p className="max-w-[600px] text-muted-foreground md:text-xl animate-slide-down" style={{ animationDelay: '100ms' }}>
            A simple yet powerful drawing tool for diagrams, wireframes, and creative collaboration.
          </p>
          
          {/* CTA Buttons */}
          <div className="flex flex-col sm:flex-row gap-4 animate-slide-down" style={{ animationDelay: '200ms' }}>
          ...
          {/* Stats */}
          <div className="grid grid-cols-3 gap-8 md:gap-12 animate-fade-in" style={{ animationDelay: '300ms' }}>
