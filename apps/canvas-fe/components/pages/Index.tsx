...
const Index = () => {
  ...
  const testimonials = [
    {
      quote:
        "CanvasFlow transformed how our team collaborates on design projects. It's simple yet powerful.",
      author: "Sarah Chen",
    ...
    {
      quote:
        "The best whiteboarding tool we've used. Perfect for our remote design sprints.",
    ...
    {
      quote:
        "I use CanvasFlow daily for client presentations. It's intuitive and makes my workflow seamless.",
      author: "Jamie Wilson",
        ...
        <div className="container px-4 md:px-6">
          <div className="text-center mb-10">
            ...
            <p className="text-muted-foreground mt-2">
              Hear from designers and teams around the world
            </p>
          </div>
              ...
              <CarouselContent className="py-4">
                {[...testimonials, ...testimonials, ...testimonials].map(
                  (testimonial, index) => (
                    ...
                    >
                      <div className="relative p-6 rounded-xl h-full bg-secondary/30 backdrop-blur-sm border overflow-hidden hover:shadow-md transition-all duration-300 hover:-translate-y-1">
